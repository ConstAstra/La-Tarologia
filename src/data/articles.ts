...
export const articles: Article[] = [
  ...
  },
  {
    ...
    category: "pratique",
    title: "Apprendre à tirer les cartes soi-même : état d'esprit, rituel et libre arbitre",
    isFree: true,
    summary: "Cette application n'a pas pour but de lire le tarot à votre place : elle est faite pour vous apprendre à le faire vous-même. Voici comment vous préparer à un tirage, et pourquoi aucune carte ne décide jamais pour vous.",
    body: [
      ...
      "Beaucoup de tarologues prennent l'habitude de « purifier » leur jeu avant de l'utiliser. Il n'est pas nécessaire d'emprunter pour cela une pratique culturelle qui n'est pas la vôtre : un geste simple et neutre suffit amplement. Frapper doucement le paquet trois fois avant de mélanger, le laisser reposer une nuit à l'air libre, ou simplement reprendre les cartes dans l'ordre de temps en temps pour repartir sur une base neutre fait très bien l'affaire. Rien de tout cela n'a besoin d'être pris au pied de la lettre pour être utile : ce geste marque une frontière claire entre le temps ordinaire et le temps du tirage, un peu comme on se lave les mains avant de cuisiner. Il recentre l'attention, et signale au corps comme à l'esprit qu'un moment différent commence. Adoptez le rituel qui vous parle, ou n'en adoptez aucun : ce qui compte, c'est l'intention que vous y mettez, pas la formule exacte, et certainement pas un objet ou un geste emprunté à une tradition que vous ne pratiquez pas par ailleurs.",
      "Cette application n'a pas pour vocation de tirer les cartes à votre place indéfiniment : elle est construite pour vous apprendre à le faire vous-même, jusqu'à ne plus en avoir besoin. Trois habitudes accélèrent vraiment cet apprentissage. D'abord, avant de lire l'interprétation proposée, regardez la carte quelques secondes et demandez-vous ce qu'elle vous évoque spontanément : votre première impression, aussi imprécise soit-elle, est un vrai point de départ, pas une erreur à corriger. Ensuite, commencez par des tirages courts, une carte ou deux, avant de vous risquer à des tirages plus complexes comme la croix celtique : la lecture d'une carte seule s'apprend, et cet apprentissage porte ensuite sur des tirages plus riches. Enfin, notez vos tirages et ce qui s'est réellement passé ensuite : c'est en confrontant vos lectures à la réalité, semaine après semaine, qu'un sens personnel des cartes se construit, bien au-delà de ce que n'importe quelle application peut vous fournir toute seule.",
